...
void *pth1(void *) {
  ...
  while ( stay_in_loop && ! exit_now ) {
    ...
    mui->subscribeNew("*/EcalEndcap/EEPedestalTask/Gain01/EEPT pedestal SM01 G01");
    mui->subscribeNew("*/EcalEndcap/EEPedestalTask/Gain06/EEPT pedestal SM01 G06");
    mui->subscribeNew("*/EcalEndcap/EEPedestalTask/Gain12/EEPT pedestal SM01 G12");
...
//      me = mui->get("Collector/FU0/EcalEndcap/EEPedestalTask/Gain01/EEPT pedestal SM01 G01");
      me = mui->get("EcalEndcap/Sums/EEPedestalTask/Gain01/EEPT pedestal SM01 G01");
...
//      me = mui->get("Collector/FU0/EcalEndcap/EEPedestalTask/Gain06/EEPT pedestal SM01 G06");
      me = mui->get("EcalEndcap/Sums/EEPedestalTask/Gain06/EEPT pedestal SM01 G06");
      h = UtilsClient::getHisto<TProfile2D*>(me);
      if ( h ) {
        c2->cd();
        h->SetOption("col");
...
//      me = mui->get("Collector/FU0/EcalEndcap/EEPedestalTask/Gain12/EEPT pedestal SM01 G12");
      me = mui->get("EcalEndcap/Sums/EEPedestalTask/Gain12/EEPT pedestal SM01 G12");
      h = UtilsClient::getHisto<TProfile2D*>(me);
      if ( h ) {
        c3->cd();
        h->SetOption("col");
...
int main(int argc, char** argv) {
  ...
  mui->subscribe("*/EcalEndcap/EEPedestalTask/Gain01/EEPT pedestal SM01 G01");
  mui->subscribe("*/EcalEndcap/EEPedestalTask/Gain06/EEPT pedestal SM01 G06");
  mui->subscribe("*/EcalEndcap/EEPedestalTask/Gain12/EEPT pedestal SM01 G12");

  CollateMonitorElement* cme;

  cme = mui->collateProf2D("EEPT pedestal SM01 G01", "EEPT pedestal SM01 G01", "EcalEndcap/Sums/EEPedestalTask/Gain01");
  mui->add(cme, "*/EcalEndcap/EEPedestalTask/Gain01/EEPT pedestal SM01 G01");

  cme = mui->collateProf2D("EEPT pedestal SM01 G06", "EEPT pedestal SM01 G06", "EcalEndcap/Sums/EEPedestalTask/Gain06");
  mui->add(cme, "*/EcalEndcap/EEPedestalTask/Gain06/EEPT pedestal SM01 G06");

  cme = mui->collateProf2D("EEPT pedestal SM01 G12", "EEPT pedestal SM01 G12", "EcalEndcap/Sums/EEPedestalTask/Gain12");
  mui->add(cme, "*/EcalEndcap/EEPedestalTask/Gain12/EEPT pedestal SM01 G12");
